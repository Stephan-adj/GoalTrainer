...
pwm.ChangeDutyCycle(50)  ## modification du rapport cyclique a 20%

print ("Rotation sens direct, au ralenti (rapport cyclique 50%)")

sleep(5)

print ("Rotation sens inverse, au ralenti (rapport cyclique 50%)")
